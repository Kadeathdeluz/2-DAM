...
PESOS_PRIORIDAD_PRODUCTOS = {"Alta": 0.5, "Media": 1, "Baja": 2}  # Pesos para productos
...
def calcular_tiempo_ajustado_producto(producto):
    return producto["tiempo"] * PESOS_PRIORIDAD_PRODUCTOS[producto["prioridad_producto"]]
...
def main():
    ...
    # Ordenar clientes por SJF con prioridad usando la función auxiliar
    clientes_ordenados = sorted(
        clientes,
        key=calcular_tiempo_ajustado_cliente  # Ordenamiento por tiempo ajustado
    )

...
class ClientePanaderia(threading.Thread):
    ...
    def run(self):
        try:
            ...
            while self.cliente_activo:
                data_cifrada = self.socket_cliente.recv(1024)
    ...
    def recibir_clave_publica_servidor(self):
        ...
        print(f"[Cliente {self.id_cliente}] Clave pública del servidor recibida: {self.key_rsa}")
    ...
    def generar_clave_aes(self):
        ...
        self.cipher_aes = AES.new(self.key_aes, AES.MODE_EAX)
        print(f"[Cliente {self.id_cliente}] Clave AES generada: {self.key_aes} -> {len(self.key_aes)} bytes")
    ...
    def enviar_clave_aes(self):
        ...
        print(f"[Cliente {self.id_cliente}] Clave AES enviada al servidor cifrada con RSA.")
    ...
    def aes_encrypt(self, data):
        ...
        return  base64.b64encode(self.cipher_aes.nonce + tag + ciphertext).decode()

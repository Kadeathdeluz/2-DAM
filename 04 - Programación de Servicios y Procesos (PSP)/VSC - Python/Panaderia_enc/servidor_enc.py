...
class Servidor:
    ...
    def manejar_cliente(self, cliente_socket: socket.socket):
        ...
        try:
            ...
            productos_codificados = self.aes_encrypt(productos)
            cliente_socket.send(productos_codificados.encode())
    ...
    def notificar_cliente(self, pedido: Pedido):
        ...
        try:
            ...
            mensaje_cifrado = self.aes_encrypt(mensaje)
            cliente_socket.send(mensaje_cifrado.encode()) # Notifica al cliente que su pedido está listo

...
class ServidorPanaderia:
    ...
    def __init__(self, num_hornos, max_ciclos, host='localhost', puerto=12345):
        ...
        self.hornos: list[Horno] = [Horno(max_ciclos) for _ in range(num_hornos)]
        self.pedidos_pendientes: list[Pedido] = []  # Lista de pedidos en espera
        self.lock_pedidos: Lock = Lock()  # Control de concurrencia Pedidos
        self.lock_hornos: Lock = Lock()  # Control de concurrencia Hornos
